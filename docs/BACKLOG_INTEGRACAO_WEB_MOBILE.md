...
| 25 | INT-025 | Política de versionamento de APIs e eventos | Critica | Em andamento (gate inicial em CI) | Regras formais de compatibilidade retroativa e depreciação com gate em CI para breaking changes |
