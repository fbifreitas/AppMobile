...
## Objetivo
Garantir que o backlog local (docs/BACKLOG_FUNCIONALIDADES.md) esteja sempre sincronizado com o board do GitHub Project, com rastreabilidade e fallback documentado.

## Passos do Agente

1. **Leitura do Backlog Local**
   - Fonte: docs/BACKLOG_FUNCIONALIDADES.md
