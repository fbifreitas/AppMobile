...
1. Backoffice web: docs/BACKLOG_BACKOFFICE_WEB.md
2. Integracao web-mobile: docs/BACKLOG_INTEGRACAO_WEB_MOBILE.md
3. Backlog mobile principal com links de governanca: docs/BACKLOG_FUNCIONALIDADES.md
4. Plano de execucao 30 dias (ownership, marcos, aceite, riscos): docs/PLANO_EXECUCAO_30_DIAS_WEB_MOBILE.md
...
- Backlogs oficiais estao em docs/BACKLOG_BACKOFFICE_WEB.md e docs/BACKLOG_INTEGRACAO_WEB_MOBILE.md.
- Plano de 30 dias em docs/PLANO_EXECUCAO_30_DIAS_WEB_MOBILE.md.
