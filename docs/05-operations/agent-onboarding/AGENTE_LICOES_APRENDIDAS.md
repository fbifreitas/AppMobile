...
- [2026-04-05] Causa raiz de regressao de release: o fix de permissao Android (`378903d`, 2026-04-05 09:32 -03) ficou somente em `codex/mvp-pack-2-20260405`/`release/v1.2.30+50` e nao foi promovido para `origin/main` (main estava em `f8566d5`). Um pacote novo (`codex/mvp-final-program-20260405`) foi iniciado a partir de `main` e seguiu para `release/v1.2.31+51` sem esse commit. Regra preventiva obrigatoria: antes de abrir release, executar gate de abrangencia `git log origin/main..HEAD --oneline` + checklist de "fixes criticos esperados" (IDs de commit/cards) e bloquear promocao se qualquer fix critico estiver fora do range da release.
