...
- Quando config/sync mobile recebem bearer token, o backend valida a sessao contra `X-Tenant-Id` e `X-Actor-Id`, bloqueando contexto divergente antes de resolver pacote ou aceitar payload finalizado.
