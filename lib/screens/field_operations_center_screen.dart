...
class FieldOperationsCenterScreen extends StatefulWidget {
  ...
  @override
  State<FieldOperationsCenterScreen> createState() =>
      _FieldOperationsCenterScreenState();
}

class _FieldOperationsCenterScreenState
    extends State<FieldOperationsCenterScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Operação de campo'),
      ),
      body: ListView(
        ...
        children: [
          ...
          if (operationState.queue.isEmpty)
            Container(
              ...
              child: const Text(
                'Nenhum item pendente na fila no momento.',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (item.conflictMessage != null &&
                        item.conflictMessage!.trim().isNotEmpty)
                      Padding(
                        padding: const EdgeInsets.only(top: 4),
                        child: Text(
                    ...
                    if (item.status == FieldOperationSyncStatus.synced)
                      const Padding(
